...
class ProgressRunnable implements Runnable {
	...
	public ProgressRunnable(ProgressBar progressbar, ProgressIndicator progressInedicator, String name,
			TextArea textarea) {
		super();
		this.progressbar = progressbar;
...
public class Ex02_ThreadRace extends Application {
	...
	// FlowPane 1개당 progressBar를 제어할 Thread가 1개씩 존재해야 함
	// Thread 객체가 나중에 실행시킬 Runnable 객체들의 리스트 생성
